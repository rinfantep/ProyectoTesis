...
import { getAllTraslado } from "../../api/traslado.api";
...
export default function Traslado() {
  ...
  useEffect(() => {
    async function fetchTable() {
      const { data } = await getAllTraslado();
      setMyTable(data);
    }
    fetchTable();
  }, []);
  ...
  const columns = [
    ...
    },
    {
      ...
      field: "investigaciones",
    },
    {
      title: "Provincia Destino",
    ...
    {
      title: "PropietarioDestino",
      field: "propietarioDestino",
    },
    {
      title: "Solicita",
      field: "solicita",
              ...
              <tbody className=" text-center">
                {results.map((dataRow, index) => (
                  <tr key={`data${index}`}>
                    ...
                    <td className="">
                      <button
                        onClick={() => navigate(`/trasladoForm/${dataRow.id}`)}
                      >
