...
export function ModeloClinicaCanino() {
  ...
  const columns = [
    ...
    {
      title: "Nuevos Enfermos",
      field: "nuevosEnfermos",
    },
    {
      title: "Muertos",
      field: "muertos",
    ...
    {
      title: "Centro informante",
      field: "centroInformante",
    },
    {
      title: "Fecha",
      field: "fecha",
    ...
    <>
      ...
      <div className="bg-white px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1 ml-4 mr-4">
        <div className="flex justify-between items-center">
          ...
          />
          <button
            onClick={() => navigate("/modeloClinCanForm")}
              ...
              {results.map((dataRow, index) => (
                <tr key={`data${index}`} className="border text-left pb-2">
                  ...
                  <td className="">
                    <button
                      onClick={() =>
                        navigate(`/modeloClinCanForm/${dataRow.id}`)
                      }
                    >
